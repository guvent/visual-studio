    ...
    class reg
    {
       ...
       public struct HKEY 
        ...
        static public bool setkey(string hkey, string key, string name, string val) 
        {
            ...
            catch (Exception er) { sonuc = false; Console.WriteLine("Kayıt Yazma Hatası: "+ er.Message); }
            return sonuc;
        }
        ...
        static public bool newkey(string hkey, string inkey, string key, string name, string val)
        {
            ...
            catch (Exception er) { sonuc = false; Console.WriteLine("Kayıt Yapma Hatası: " + er.Message); }
            return sonuc;
        }
        ...
        static public object getkey(string hkey, string key, string name)
        {
            ...
            catch (Exception er) { Console.WriteLine("Kayıt Defteri Hatası: " + er.Message); }
